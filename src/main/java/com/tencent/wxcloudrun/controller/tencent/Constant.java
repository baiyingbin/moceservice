...
public class Constant {
    ...
    public static String Product_Tiia_Endpoint= "tiia.tencentcloudapi.com";

    public static String Region= "ap-beijing";

    public static String FACE_IMAGE_URL = "https://appimg.dzwww.com/share/2022/10/25/cd4d701720762d2_750.JPEG";
